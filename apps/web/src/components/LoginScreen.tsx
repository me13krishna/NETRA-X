    ...
    <div className="min-h-screen bg-netra-bg flex items-center justify-center p-4 font-sans relative overflow-hidden">
      ...
      <div className="w-full max-w-md bg-netra-card border border-netra-border rounded-2xl p-8 shadow-2xl glass-panel relative z-10 space-y-6">
        <div className="text-center space-y-2">
          <div className="w-12 h-12 rounded-xl bg-netra-purple flex items-center justify-center font-bold text-xl text-netra-bg shadow-xl mx-auto">
            N
          </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4 text-xs">
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full py-3 rounded-lg bg-netra-purple hover:bg-netra-deepViolet text-netra-bg font-bold text-xs flex items-center justify-center space-x-2 shadow-lg transition hover:opacity-90 disabled:opacity-50"
          >
